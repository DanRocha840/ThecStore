...
let textoPesquisa = ""
let categoriaAtual = "all"; // Inicializa como "all" para mostrar todos os produtos
let produtos = [
    {
        id: 1,
        nome: "iPhone 15 Pro",
...
let containerProdutos = document.querySelector(".products");
...
function mostrarProdutos() {
    ...
    produtosFiltrados.forEach(prd => { // Alterado para produtosFiltrados
        htmlProdutos += `
...
function trocarCategoria(categoria) {
    ...
    todosBotoes.forEach(botao => {
        ...
        if (botao.getAttribute("data-category") === categoria) { // Corrigido para getAttribute
